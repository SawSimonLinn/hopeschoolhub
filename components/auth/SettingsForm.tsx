...
export function SettingsForm() {
  ...
  async function onSubmit(data: SettingsFormData) {
    ...
    if (data.newUsername.toLowerCase() !== data.currentUsername.toLowerCase()) {
      ...
      if (usernameUpdated) {
        ...
        toast({
          ...
          description:
            'Could not update username. Please ensure current username is correct.',
        });
      }
    }
    ...
    if (data.newPassword) {
      ...
      passwordMessage =
        ' Password change acknowledged (demo - password not stored).';
    }
    ...
    if (
      !usernameUpdated &&
      data.newUsername.toLowerCase() !== data.currentUsername.toLowerCase()
    ) {
  ...
  return (
    <Card className='w-full max-w-xl shadow-xl'>
      <CardHeader>
        ...
        <CardDescription>
          Update your username/email, profile picture, and password.
        </CardDescription>
      </CardHeader>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className='space-y-6'>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor='currentUsername'>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor='profilePicUrl'>
            ...
            >
              ...
              <AlertDescription>
                For this demonstration, the admin login uses a specific
                hardcoded password (`adminpassword`). Password changes entered
                here are acknowledged but not fully implemented to update this
                hardcoded value, as there is no secure backend storage.
              </AlertDescription>
            </Alert>
