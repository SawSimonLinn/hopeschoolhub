...
export default function StudentDetailsPage() {
  ...
  const handlePaymentUpdate = async (
    ...
    try {
      const updatedStudent = await updateStudentPaymentStatus(
        student.id,
        monthIndex,
        newStatus
      );
          ...
          <Card className='shadow-xl'>
            <CardHeader className='flex flex-col md:flex-row items-start gap-6'>
              ...
              <div className='w-full'>
                ...
                <CardDescription className='text-base'>
                  All recorded details for {student.name}.
                </CardDescription>
            ...
            <CardContent className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2 pt-6 border-t'>
              ...
              {detailItem(
                CalendarDays,
                'Date of Birth',
                student.dob && isValid(parseISO(student.dob))
                  ? format(parseISO(student.dob), 'MMMM d, yyyy')
                  : 'N/A',
                false,
                'secondary',
                true
              ...
              {detailItem(
                ...
                student.registrationDate &&
                  ...
                  ? format(parseISO(student.registrationDate), 'MMMM d, yyyy')
                  : 'N/A'
              )}
              {detailItem(
                Briefcase,
                'Years of Enrollment',
                student.yearsOfEnroll
              )}
              {detailItem(
                Users,
              ...
              {detailItem(
                ShieldCheck,
                'Eligible for Transfer Certificate',
                student.canTransferCertificate
              )}
              {detailItem(
                Hash,
